...
import AddPolitiqueArticle from '../AdminPage/AddPolitiqueArticle';
import AddPolitiqueVideo from '../AdminPage/AddPolitiqueVideo';

function AdminPolitique() {
