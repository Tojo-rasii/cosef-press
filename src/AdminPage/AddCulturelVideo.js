...
function AddCulturelVideo() {
    ...
    const handleVideoSubmit = async (event) => {
        ...
        const fileName = `videoCulturel/${video.name}`;
        ...
        try {
            ...
            const docRef = await addDoc(collection(database, 'videoCulturelPublished'), videos);
            ...
            <main className="m-2 bg-white p-4 d-flex flex-row gap-5" style={{ outline: "1px solid silver", width: "200%" }}>
                ...
                <section className="d-flex flex-column flex-wrap gap-2">
                    <article className='p-3 bg-light' style={{ outline: "1px solid silver" }}>
                        <p className='fw-semibold'>VIDEO CULTUREL</p>
...
export default AddCulturelVideo;
