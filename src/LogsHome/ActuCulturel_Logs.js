  ...
  return (
    <div>
          {/* contenue article SECTION */}
                ...
                <NavLink to="/logsCulturel" style={{textDecoration : "none"}}><p className='text-uppercase fw-semibold fs-4'><span style={{ fontWeight : "800"}}>Culturel</span></p></NavLink>
...
export default ActuCulturel_Logs