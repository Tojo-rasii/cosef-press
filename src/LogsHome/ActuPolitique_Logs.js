  ...
  return (
    <div>
          {/* contenue article SECTION */}
                ...
                <NavLink to="/logsPolitique" style={{textDecoration : "none"}}><p className='text-uppercase fw-semibold fs-4'><span style={{ fontWeight : "800"}}>Politique</span></p></NavLink>
...
export default ActuPolitique_Logs