        ...
        <div>
            <main className='ClickArticle'>
                ...
                <p className='text-uppercase fw-semibold fs-4 titleClick'>
                    <NavLink to="/logsHome"><i className='bi-arrow-left-circle'></i></NavLink>&nbsp;&nbsp;ACTUALITE <span style={{ fontWeight : "800"}}>{articleType}</span></p>
...
export default ClickArticle_Logs