    ...
    return (
        <div>
            <main className='ClickArticle'>
                {/* CLICK ARTICLE PHOTO */}
                <div>
                <p className='text-uppercase fw-semibold fs-4 titleClick'><NavLink to="/logsHome"><i className='bi-arrow-left-circle'></i></NavLink>&nbsp;&nbsp;Video <span style={{ fontWeight : "800"}}>{articleType}</span></p>
...
export default ClickVideo_Logs