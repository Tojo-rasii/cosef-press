        ...
        <div className='zonePublicite'>
            ...
            <footer>
                <div>
                    ...
                    <section>
                        <p>contact</p>
                        <NavLink style={{fontSize: "0.8em",textDecoration:"none", color:"rgb(103, 103, 103)", fontWeight:"light"}} to="/logsApropos"><p>A propos de nous</p></NavLink>
                    ...
                    <section>
                        ...
                        <NavLink style={{fontSize: "0.8em",textDecoration:"none", color:"rgb(103, 103, 103)", fontWeight:"light"}} to="/logsMotDuQuesteur"><p>Mot du questeur</p></NavLink>
                        <NavLink style={{fontSize: "0.8em",textDecoration:"none", color:"rgb(103, 103, 103)", fontWeight:"light"}} to="/logsMiniBiographie"><p>Mini-Biographie</p></NavLink>
                    </section>
                    <section>
                        <p>Archive</p>
                        <NavLink style={{fontSize: "0.8em",textDecoration:"none", color:"rgb(103, 103, 103)", fontWeight:"light"}} to="/logsSearch"><p>Recherche</p></NavLink>
                        <p></p>
                        <p></p>
                    </section>
                    <section>
