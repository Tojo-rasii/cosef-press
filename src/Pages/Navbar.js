...
import securityKeys from '../Contexts/Keys/securityKeys.json';
...
function Navbar() {
  ...
  // LOGIN FORM SIGN IN
    ...
    // Check if the provided username and password match the security keys from JSON
    const { username, password } = formData;
    if (securityKeys[username] && securityKeys[username] === password) {
        // If they match, navigate to the admin dashboard
        navigate('/adminHome');
        alert("you are connected to admin dashboard")
        return;
    }
        try {
                    ...
                    <nav className='Nav2'>
                        ...
                        <section>
                            ...
                            <div className='Contenu-Login' style={{ display: active ? "block" : "none" }} >
                                <section>
                                    <article onClick={toggPop}>
                                        <span>
                                            <i className="bi bi-box-arrow-in-right  fs-3" id="btn-Login"></i>
                                        </span>
                                        <span>
                                            <p>Se connecter</p>
                                        </span>
                        ...
                        <main>
                            ...
                            <section>
                                <form>
                                    ...
                                    <article style={{cursor:"pointer"}} className='log-google' onClick={handleSignInWithGoogle}>
                                        <span>
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 48 48">
