...
function Body_Sport() {
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            try {
                const querySnapshot = await getDocs(collection(database, 'articleCulturelPublished'));
    ...
    useEffect(() => {
        const fetchVideos = async () => {
            try {
                const querySnapshot = await getDocs(collection(database, 'videoCulturelPublished'));
                const fetchedVideos = [];
                querySnapshot.forEach((doc) => {
