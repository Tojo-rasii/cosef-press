...
function Body_Sport() {
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            try {
                const querySnapshot = await getDocs(collection(database, 'articleSocialPublished'));
    ...
    useEffect(() => {
        const fetchVideos = async () => {
            try {
                const querySnapshot = await getDocs(collection(database, 'videoSocialPublished'));
                const fetchedVideos = [];
                querySnapshot.forEach((doc) => {
